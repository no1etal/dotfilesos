...
# Add ~/.local/bin at the beginning of $PATH
export PATH=~/.local/bin:$PATH

# Add /home/kopachke/.local/bin and /usr/bin to $PATH
export PATH="$PATH:/home/kopachke/.local/bin:/usr/bin:$HOME/.cargo/bin"
# Monero wallet path
...
#
# Example aliases
# alias czsh="mate ~/.zshrc"
# alias cohmyzsh="mate ~/.oh-my-zsh"
#my aliases
 ...
 alias cnitrogen="lvim /home/kopachke/.config/nitrogen/nitrogen.cfg"
 alias ctermscp="lvim /home/kopachke/.config/termscp/config.toml"
 alias npicom="lvim ~/.config/picom.conf"

 alias librewolf="flatpak run io.gitlab.librewolf-community"
 alias livecaptions="flatpak run net.sapples.LiveCaptions"
 alias mullwad="flatpak run net.mullvad.MullvadBrowser"
 alias zug="curl wttr.in/zug"
 alias addbook="sudo calibredb add ~/calibre-upload/* --library-path ~/calibre-library"
 alias cg="chatgpt"
 alias i="chatgpt -i"
 alias netactive="sudo virsh net-list --all" # fixes virtual machiine not workling (How to fix "network 'default' is not active" error in libvirt)
...
alias ncas="$EDITOR /home/kopachke/.config/castero/castero.conf"
alias nly="sudo $EDITOR /etc/ly/config.ini"
alias nircd="$EDITOR /home/kopachke/.config/darkfi/ircd_config.toml"
alias ndarfid="$EDITOR ~/.config/darkfi/darkfid_config.toml"
#gpg
